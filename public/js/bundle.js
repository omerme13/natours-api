      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.status === 200) {
              (0, _alerts.default)('success', 'You logged in successfully');
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            (0, _alerts.default)('error', 'Error logging out, try again later.');
...
exports.clearFields = exports.updateSettings = void 0;
...
var stripe = Stripe('pk_test_N2xPxu2lrQaBNPMjxttGTq8h00dKSsk8aH');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 9:
            ...
            (0, _alerts.default)('error', _context.t0);
...
var displayMap = function displayMap(locations) {
  ...
  try {
    for (var _iterator = locations[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
      ...
      popup.setLngLat(loc.coordinates).setHTML("day ".concat(loc.day, ": ").concat(loc.description)).addTo(map);
...
var submitSettingsForm = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            ...
            (0, _updateSettings.clearFields)('password-current', 'password', 'password-confirm');
  ...
  return function submitSettingsForm(_x) {
    return _ref.apply(this, arguments);
  };
}();

var bookTourHandler = function bookTourHandler(e) {
  e.target.textContent = 'Booking...';
  (0, _stripe.bookTour)(bookTourBtn.dataset.tourId);
};

if (mapBox) {
  var locations = JSON.parse(mapBox.dataset.locations);
  (0, _mapbox.default)(locations);
}
...
if (logoutButton) {
  logoutButton.addEventListener('click', _auth.logout);
}
